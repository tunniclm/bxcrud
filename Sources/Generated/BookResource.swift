...
public class BookResource {
    private let adapter: BookAdapter
    private let path = "/api/books"
    private let pathWithID = "/api/books/:id"

    init(factory: AdapterFactory) throws {
        adapter = try factory.getBookAdapter()
    }
